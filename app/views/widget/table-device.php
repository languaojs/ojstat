<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <table class="table table-condensed table-hover table-sm" id="device" title="OJStat | Device Widget">
                <thead>
                ...
                <tbody>
                    <?php 
                        ...
                        {
                            $icons = "<img src='".BASEURL."/public/img/icons/".strtolower($tbl['pv_device']).".png' width='30' height='30'/>";
                            echo "<tr>";
                            echo "<td>";
                            echo $icons ."  ". Sanitize::clean($tbl['pv_device']);
