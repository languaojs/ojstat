<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <table class="table table-condensed table-hover table-sm" id="system" title="OJStat | Operating System Widget">
                <thead>
                ...
                <tbody>
                    <?php 
                        ...
                        {
                            $icons = "<img src='".BASEURL."/public/img/icons/".strtolower($tbl['pv_os']).".png' width='30' height='30'/>";
                            echo "<tr>";
                            echo "<td>";
                            echo $icons ."  ". Sanitize::clean($tbl['pv_os']);
