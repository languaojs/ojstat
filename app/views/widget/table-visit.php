<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <table class="table table-condensed table-hover table-sm" id="visit" title="OJStat | Visit Statistic Widget">
                <thead>
                ...
                <tbody>
                    <?php 
                        foreach($data['data'] as $tbl)
                        {
                            echo "<tr>";
                            echo "<td>";
                            echo Sanitize::clean($tbl['pv_date']);
                            echo "<td>";
                            echo Sanitize::clean(date('F Y', strtotime($tbl['pv_date'])));
